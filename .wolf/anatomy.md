...
- `i-m-looking-to-redo-zesty-mango.md` — Atlantic Pools Website Redesign — Design Spec & Implementation Plan (~1866 tok)
...
## .superpowers/brainstorm/1105-1776381730/content/

- `design-direction.html` (~956 tok)
- `homepage-layout.html` (~1513 tok)
- `waiting.html` (~46 tok)
